...
export default function TermsPage() {
  return (
    <div className="wrap">
      ...
      <p>These Terms of Service (“Terms”) form a binding agreement between you and <strong>Inmedia AI Inc</strong> (“Inmedia AI,” “Company,” “we,” “us,” or “our”), the operator of the <strong>OneTap Atelier</strong> platform, websites, and applications (the “Service”). OneTap Atelier is a product of Inmedia AI Inc, and all rights in the Service are reserved by Inmedia AI Inc. By accessing or using the Service, you agree to these Terms and to our Privacy Policy. If you do not agree, do not use the Service.</p>
      ...
      <ul>
        ...
        <li>The Service is offered on a subscription basis with two plans: <strong>$25 per month, including ten Try-On Films per billing cycle</strong>, and <strong>$49 per month, including <span className="ph">[number]</span> Try-On Films per billing cycle</strong>. The plan you select and its included allowance are shown at sign-up.</li>
        ...
        <li>Payments are handled by a third-party processor (for example, <span className="ph">[Stripe]</span>). Fees are stated exclusive of taxes, which you are responsible for where applicable.</li>
        <li>Except where required by law, fees are non-refundable. <span className="ph">[State your refund policy here.]</span></li>
      </ul>

      <h2>5. Your content and the rights you grant</h2>
      <p>“User Content” means anything you upload or submit, including images and video of yourself (“Likeness Content”) and item inputs. You retain ownership of your User Content. You grant Inmedia AI Inc a limited, worldwide, non-exclusive, royalty-free license to host, store, process, and modify your User Content solely as necessary to operate the Service and provide your Try-On Films. This license ends when you delete the content or close your account, except for copies retained as described in the Privacy Policy.</p>
      <p><strong>We do not use your User Content to train AI models without your separate, explicit opt-in consent</strong> (see the Privacy Policy).</p>
